...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      max-auto mt-10 text-center'>Turn text to <span className='text-blue-500'
      initial={{opacity:0}}
      animate={{opacity:1}}
      ...
      >Unleash yourr creativity with AI. Turn your imagination into visual
        art in seconds-just type, and watch the magic happen.
      </motion.p>

      <motion.button onClick={onClickHandler}
      className='sm:text-lg text-white bg-black w-auto
      mt-8 px-6 py-2.5 flex items-center gap-2 rounded-full'
