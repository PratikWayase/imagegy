...
const Login = () => {
  ...
  return (
    ...
    backdrop-blue-sm bg-black/30 flex justify-center items-center'>
      ...
      text-slate-500'>
        ...
        { state === 'Login' ? <p className='mt-5 text-center'>Dont have an account ? 
          <span className='text-blue-600 cursor-pointer flex flex-col' onClick={()=>setState('sign up')}>sign up</span></p>
        :
        <p className='mt-5 text-center'>Already have an account ?
        <span className='text-blue-600 cursor-pointer flex flex-col' onClick={()=>setState('Login')}>Log in </span></p> }
